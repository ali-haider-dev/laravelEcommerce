...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.2/css/all.min.css" xintegrity="sha512-SnH5WK+bZxgPHs44uWIX+LLMDJmN2/qJtyZl8D1pE3P+J/nQ9y3P+c9jBqH8q8s/X5Gv8Qv3v9Z" crossorigin="anonymous" referrerpolicy="no-referrer" />
...
<body class="bg-gray-100 min-h-screen">
    ...
    <div id="accordionSidebar" 
        ...
        <ul class="flex flex-col py-2 space-y-1">
            ...
            <li class="nav-item">
                <a class="nav-link flex items-center p-3 mx-3 rounded-lg text-sm font-medium bg-indigo-700/30 text-indigo-200" href="{{ route('admin.dashboard') }}">
            ...
            <!-- Nav Item - Uploads -->
            <li class="nav-item">
                <a class="nav-link flex items-center p-3 mx-3 rounded-lg text-sm font-medium hover:bg-indigo-700/20 transition-colors duration-150" href="#">
            ...
            <!-- Nav Item - Products -->
            <li class="nav-item">
                <a class="nav-link flex items-center p-3 mx-3 rounded-lg text-sm font-medium hover:bg-indigo-700/20 transition-colors duration-150" href="{{ route('products') }}">
            ...
            <li class="nav-item relative">
                <a id="reportsDropdownToggle" 
                   ...
                   onclick="toggleDropdown('reportsMenu')">
                    ...
                    <!-- Dropdown Arrow Icon -->
                    <i id="reportsIcon" class="fa-solid fa-chevron-down text-xs transform transition-transform duration-300"></i>
                </a>

                <!-- Dropdown Menu (Hidden by default) -->
                <div id="reportsMenu" class="dropdown-menu ml-3 mt-1 py-1 bg-gray-800/80 backdrop-blur-sm rounded-lg shadow-xl hidden transition-all duration-300 overflow-hidden">
                    <h6 class="px-5 py-2 text-xs font-semibold text-gray-400 border-b border-gray-700/50">Reporting Revenue</h6>
             
                    <a class="dropdown-item block px-5 py-2 text-sm text-gray-200 hover:bg-indigo-700/30" href="{{ route('reports.show', ['type' => 'monthly']) }}">Revenue by Month</a>
                    <a class="dropdown-item block px-5 py-2 text-sm text-gray-200 hover:bg-indigo-700/30" href="{{ route('reports.show', ['type' => 'yearly']) }}">Revenue by Year</a>
                    <a class="dropdown-item block px-5 py-2 text-sm text-gray-200 hover:bg-indigo-700/30" href="{{ route('reports.show', ['type' => 'category']) }}">Revenue by Category</a>
                    <a class="dropdown-item block px-5 py-2 text-sm text-gray-200 hover:bg-indigo-700/30" href="{{ route('reports.show', ['type' => 'categoty_yearly']) }}">Revenue by Cat & Year</a>
                </div>
            </li>
        ...
        <div class="mt-auto p-4 flex justify-center ms-auto">
             <button id="sidebarToggle" class="w-8 h-8 rounded-full bg-indigo-700 hover:bg-indigo-600 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-colors duration-150 text-white hidden md:block" title="Toggle Sidebar">
