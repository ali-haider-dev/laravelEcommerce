    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                <!-- Total Orders -->
                <div
                    class="bg-gradient-to-br from-indigo-500 to-indigo-600 rounded-2xl shadow-lg p-6 text-white transform hover:scale-105 transition-all duration-300">
                    <div class="flex items-center justify-between">
                        <div>
                ...
                <!-- Pending Orders -->
                <div
                    class="bg-gradient-to-br from-yellow-500 to-yellow-600 rounded-2xl shadow-lg p-6 text-white transform hover:scale-105 transition-all duration-300">
                    <div class="flex items-center justify-between">
                        <div>
                ...
                <div
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-4xl font-bold">{{ $orders->where('order_status', 'processing')->count() }}
                            </p>
                ...
                <!-- Delivered Orders -->
                <div
                    class="bg-gradient-to-br from-green-500 to-green-600 rounded-2xl shadow-lg p-6 text-white transform hover:scale-105 transition-all duration-300">
                    <div class="flex items-center justify-between">
                        <div>
                ...
                <div class="p-6">
                    ...
                    <form method="GET" action="{{ route('admin.searchOrders') }}" class="space-y-4">
                        <div class="grid grid-cols-1 md:grid-cols-12 gap-4">
                            ...
                            <!-- Order Status Filter -->
                            <div class="md:col-span-3">
                                <label for="order_status" class="block text-sm font-medium text-gray-700 mb-2">Order
                                    Status</label>
                                <select name="order_status" id="order_status"
                                    class="block w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors">
                                    <option value="">All Orders</option>
                                    <option value="pending"
                                        {{ request('order_status') == 'pending' ? 'selected' : '' }}>⏳ Pending</option>
                                    <option value="processing"
                                        {{ request('order_status') == 'processing' ? 'selected' : '' }}>⚙️ Processing
                                    </option>
                                    <option value="shipped"
                                        {{ request('order_status') == 'shipped' ? 'selected' : '' }}>🚚 Shipped
                                    </option>
                                ...
                                <tr class="hover:bg-gray-50 transition-colors">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex flex-col">
                                            <span
                                                class="text-xs font-medium text-gray-500">#{{ $order->id }}</span>
                                            <span
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            <div
                                                class="h-10 w-10 rounded-full bg-gradient-to-br from-indigo-400 to-indigo-600 flex items-center justify-center text-white font-bold text-sm">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="space-y-1">
                                            ...
                                            @endphp
                                            <span
                                                class="inline-flex items-center px-2.5 py-1 rounded-lg text-xs font-semibold ring-1 ring-inset {{ $paymentColors[$order->payment_status] ?? 'bg-gray-50 text-gray-700 ring-gray-600/20' }}">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap min-w-[200px]">
                                        <div class="flex flex-col">
                                            <span
                                                class="text-sm font-medium text-gray-900">{{ $order->shipping_address }}</span>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap min-w-[200px] ">
                                        <div class="flex flex-row gap-2 ml-5">
                                            <a href="#"
                                                class="relative group text-indigo-600 hover:text-indigo-900 font-medium text-sm flex items-center gap-1">

                                                <!-- Eye Icon (Bootstrap Icons) -->
                                ...
                                <tr>
                                    <td colspan="6" class="px-6 py-16 text-center">
                                        <div class="flex flex-col items-center justify-center">
                                            ...
                                            <p class="text-sm text-gray-500">Try adjusting your search or filter
                                                criteria</p>
                                        </div>
                                    </td>
                                </tr>
        ...
        document.querySelectorAll('.status-update-form select').forEach(select => {
            ...
            select.addEventListener('change', function(e) {
                ...
                loadingSpinner.className =
                    'inline-block ml-2 w-4 h-4 border-2 border-gray-300 border-t-indigo-600 rounded-full animate-spin';
